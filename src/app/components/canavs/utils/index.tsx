...
const defaultPoints: Record<string, any>   = {
    'RECTANGLE': [[-100, 100, 0], [0, 100, 0], [0, 0,0], [-100, 0, 0]],
    'TRIANGLE': [[-100, 100, 0], [0, 100, 0], [0, 0, 0]],
    'CIRCLE': [80] as [number],
...
export function generateShape(shape: string, id: string): JSX.Element | undefined{
    ...
    return <PolyLine id={id} defaultStart={defaultPoints.LINE[0]} defaultEnd={defaultPoints.LINE[1]} />
    return undefined
